        ...
        <div className="testimonials-container">
            <div className="wrapper">
                ...
                <div className="details-container">
                    ...
                    <p className="detail">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos minus, harum architecto et hic fugiat blanditiis, commodi perspiciatis earum aspernatur</p>
                    <div className="personal-detail">
                        <p className="name">May Anderson</p>
                        <p className="position">Workstation, CTO</p>
                    </div>
                </div>
            </div>
        </div>
